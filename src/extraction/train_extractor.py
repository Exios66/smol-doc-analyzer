...
def train(
    ...
    write_json(
        out / "train_meta.json",
        {"model_name": model_name, "smoke": smoke, "n_train": len(train_rows)},
    )
    log_provenance(
...
def main() -> None:
    ...
    print(train(args.prepared, Config.load(), args.model, args.out, args.max_steps, args.smoke))
