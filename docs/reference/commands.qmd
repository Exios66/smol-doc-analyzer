...
::: {.hero-lead}
High-frequency CLI entry points. Full flag semantics and recipes live in
[Usage](../usage.md).
:::
...
Guides: [DICIE Pipeline](../docie_pipeline.qmd) ·
...
Guides: [Architecture](../architecture.qmd) ·
...
# python -m src.rvl_cdip download-images --i-understand-large-download  # ~38 GB
```

Guide: [RVL-CDIP SQL Index](../rvl_cdip_sql.md) ·
[OpenRouter eval notebook](../notebooks/rvl_cdip_openrouter_eval.ipynb)
