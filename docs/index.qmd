...
|------|----------|-------|----------|
| **DICIE** | Paper Fig. 1 medical / salvage image-first flow | [DICIE Pipeline](docie_pipeline.md) | [Walkthrough](notebooks/docie_pipeline_walkthrough.ipynb) |
| **Memo chain** | ACORD-style intake + adjuster memos | [Usage](usage.md) · [Architecture](architecture.md) | [Walkthrough](notebooks/pipeline_walkthrough.ipynb) |
