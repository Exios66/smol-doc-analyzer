#!/usr/bin/env python3
"""Generate notebooks/rvl_cdip_openrouter_eval.ipynb and docs symlink."""
...
OUT = REPO / "notebooks" / "rvl_cdip_openrouter_eval.ipynb"
DOCS_LINK = REPO / "docs" / "notebooks" / "rvl_cdip_openrouter_eval.ipynb"
CELLS_JSON = Path(__file__).with_name("rvl_cdip_openrouter_eval_nb_cells.json")
